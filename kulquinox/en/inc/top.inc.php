	...
	?></h1>
				...
				<div id="header_menu">
					<ul class="header_menu_list">
							<li class="facebook"><a href="http://www.facebook.com/kulquinox">Like us on Facebook</a></li>
							<li class="twitter"><a href="https://twitter.com/#!/Kulquinox">Follow us on Twitter</a></li>
<?php
switch ($folder) {
	case('0'):
?>
